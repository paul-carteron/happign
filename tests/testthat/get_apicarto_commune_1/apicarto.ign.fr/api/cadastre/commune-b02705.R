structure(list(method = "GET", url = "https://apicarto.ign.fr/api/cadastre/commune?code_insee=29760&source=PCI", 
    ...
    body = charToRaw("{\"type\":\"FeatureCollection\",\"features\":[],\"totalFeatures\":0,\"numberMatched\":0,\"numberReturned\":0,\"timeStamp\":\"2022-10-09T11:39:28.211Z\",\"crs\":null}")), class = "httr2_response")
