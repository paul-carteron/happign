structure(list(method = "GET", url = "https://apicarto.ign.fr/api/cadastre/commune?code_insee=29760&source_ign=PCI", 
    status_code = 200L, headers = structure(list(`Access-Control-Allow-Origin` = "*", 
        ...
        `Content-Length` = "147", Date = "Sat, 08 Oct 2022 15:26:56 GMT", 
    ...
    body = charToRaw("{\"type\":\"FeatureCollection\",\"features\":[],\"totalFeatures\":0,\"numberMatched\":0,\"numberReturned\":0,\"timeStamp\":\"2022-10-08T15:26:56.455Z\",\"crs\":null}")), class = "httr2_response")
