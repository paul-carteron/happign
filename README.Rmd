...
The goal of happign is to facilitate the use of Application Programming Interface from the French National Institute of Geographic and Forestry Information.
...
Please check package vignette "Getting_started" for basic use of `happign` or articles on the [website](https://paul-carteron.github.io/happign/articles/Getting_started.html)
``` r
