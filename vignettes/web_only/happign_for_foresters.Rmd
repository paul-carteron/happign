...
```{r debug-camors, include=FALSE}
# Show that camors_border is non‐empty and has the expected CRS
print(camors_border)
print(st_crs(camors_border))
print(st_bbox(camors_border))

# Show the layer name you’re using
layers <- get_layers_metadata("wfs", "parcellaire")
parcellaire_layer <- layers[15,1]
print(parcellaire_layer)
```
