 ...
 * *IGN WFS can return a maximum of 1000 features. The get_wfs() function overrides this limit by performing several consecutive requests, that why there 10 request aboves ;*
...
- 1 ZPS ("Zone de protection spéciale" in green)
