...
MNT <- get_wms_raster(borders, "altimetrie", resolution = 5, MNT_name, filename = "MNT.tif")
MNS <- get_wms_raster(borders, "altimetrie", resolution = 5, MNS_name, filename = "MNS.tif")
...
IRC <- get_wms_raster(shape = biggest_parcels,
                      ...
                      filename = "IRC.tif")
IRC <- st_as_stars(IRC) # Needed for quick plotting
...
The call to the function `get_wms_info` indicates that this orthophoto was taken in `r info_sup[5]`.
...
etat_major <- get_wms_raster(shape = borders,
                            ...
                            filename = "etat_major.tif")

etat_major <- st_as_stars(etat_major, ignore_file = TRUE) # Needed for quick plotting
