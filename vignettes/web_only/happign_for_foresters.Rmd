...
MNT = get_wms_raster(borders, "altimetrie", resolution = 10, MNT_name, filename = "MNT")
file.remove("MNT.tif") # I don't want to keep MNT on disk because this is vignette
MNS = get_wms_raster(borders, "altimetrie",resolution = 10, MNS_name, filename = "MNS")
...
etat_major <-  get_wms_raster(shape = borders,
                            apikey = "cartes",
                            resolution = 20, # You be more precise but it's already 4MB of data
...
tm_shape(etat_major, raster.downsample = FALSE)+
   tm_rgb()+
tm_shape(borders)+
