...
``` r
get_apikeys()
#>  [1] "administratif" "adresse"       "agriculture"   "altimetrie"    "cartes"       
#>  [6] "cartovecto"    "clc"           "economie"      "enr"           "environnement"
#> [11] "geodesie"      "lambert93"     "ocsge"         "ortho"         "orthohisto"   
#> [16] "parcellaire"   "satellite"     "sol"           "topographie"   "transports"
...
tm_compass(type = "arrow")+
tm_scalebar()
#> [plot mode] fit legend/component: Some legend items or map compoments do not fit
#> well, and are therefore rescaled.
#> ℹ Set the tmap option `component.autoscale = FALSE` to disable rescaling.
```

<div class="figure" style="text-align: center">
<img src="figure/get_wms_raster-1.png" alt="plot of chunk get_wms_raster"  />
<p class="caption">plot of chunk get_wms_raster</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/get_wmts-1.png" alt="plot of chunk get_wmts"  />
<p class="caption">plot of chunk get_wmts</p>
</div>
